...
public class TesteBarResumido {
	...
	@Test
	public void testarContaSimples() throws ContaAberta, ContaFechada, ContaInexistente, DadosInvalidos, ItemJaCadastrado, ItemInexistente{
		Bar b = new Bar();
	...
	@Test
	public void testarInserirContaFechada() throws ContaAberta, ContaInexistente, ContaFechada, DadosInvalidos, ItemJaCadastrado, ItemInexistente{
		Bar b = new Bar();
		b.addCardapio(1, "Cerveja Brahma", 5.5, 2);
		b.addCardapio(2, "File com Fritas", 28, 3);
	...
	@Test
	public void testarPagarContaEmPartes() throws ContaAberta, ContaInexistente, ContaFechada, PagamentoMaior, DadosInvalidos, ItemJaCadastrado, ItemInexistente{
		Bar b = new Bar();
		b.addCardapio(1, "Cerveja Brahma", 5.5, 2);
		b.addCardapio(2, "File com Fritas", 28, 3);
	...
	@Test
	public void testarContaInexistente() throws ContaAberta, ContaFechada, PagamentoMaior, ContaInexistente, DadosInvalidos, ItemJaCadastrado, ItemInexistente{
		Bar b = new Bar();
		b.addCardapio(1, "Cerveja Brahma", 5.5, 2);
		b.addCardapio(2, "File com Fritas", 28, 3);
	...
	@Test
	public void testarContaJaExistente() throws ContaInexistente, ContaAberta, DadosInvalidos{
		Bar b = new Bar();
		b.abrirConta(1, 1, "Pedro");
		try {
	...
	@Test
	public void testarExtratoItens() throws ContaAberta, ContaFechada, PagamentoMaior, ContaInexistente, DadosInvalidos, ItemJaCadastrado, ItemInexistente{
		Bar b = new Bar();
		b.addCardapio(1, "Cerveja Brahma", 5.5, 2);
		b.addCardapio(2, "File com Fritas", 28, 3);
